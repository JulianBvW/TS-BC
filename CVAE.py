# Modified copy from STEVE-1 code
# https://github.com/Shalev-Lifshitz/STEVE-1/blob/main/steve1/data/text_alignment/vae.py
...
def load_cvae(weights_file='weights/cvae/steve1_prior.pt', device='cuda'):
    model = TranslatorVAE(input_dim=512, hidden_dim=512, latent_dim=512)
